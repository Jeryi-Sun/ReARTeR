...
def load_corpus(corpus_path: str):
    corpus = datasets.load_dataset("json", data_files=corpus_path, split="train",cache_dir="/new_disk3/zhongxiang_sun/code/RAG_Reasoning/FlashRAG/flashrag_data/dataset/cache/")
    return corpus
