...
def main():
    ...
    log_file_path = f'./{args.dataset_name}/logs/processing_log_{current_time}_llama_v2.log'
    ...
    for i, item in enumerate(data):
        ...
        if 0 < sum(correctness_flags) < max_rollouts:
            ...
            filename = f"./{args.dataset_name}/rft_results/{i+1}_nodes_data_llama_v2.json"
